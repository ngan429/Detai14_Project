...
class UserCreateTable(db.Model):
    __tablename__ = "InfoAddRowDatabase"
    Id = db.Column(db.Integer(), primary_key=True, autoincrement=True)
    NameDatabase = db.Column(db.String(length=200), nullable=False)
    NameTable = db.Column(db.String(length=200), nullable=False)
